...
<div style="text-align: right; margin-top: 150px; margin-right: 10px;">
    <a href="../../model/panie.php" style="padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px; font-size: 16px;">
        🛒 Voir le Panier
    </a>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('.ajouter-panier-btn').on('click', function (e) {
            ...
            $.ajax({
                url: '../../controller/ajouter_au_panier.php',
                type: 'POST',
