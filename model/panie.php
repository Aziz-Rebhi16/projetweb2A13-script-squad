...
function afficherPanier() {
    ...
    if (!empty($_SESSION['panier'])) {
        ...
        echo "<a href='../view/frontOffice/confirmation.php' class='btn btn-success'>Passer à la caisse</a>";
        echo "</div>";
    } else {
        ...
        <nav class="navbar navbar-expand-lg">                
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="ms-lg-3">
                        <a class="btn custom-btn custom-border-btn" href="../view/frontOffice/produitview.php">Boutique<i class="bi-arrow-up-right ms-2"></i></a>
                    </div>
