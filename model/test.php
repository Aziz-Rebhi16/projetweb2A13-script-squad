                        ...
                        <div class="col-md-4 mb-4">
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    ...
                                    <a href="../controller/update_produit.php?id=<?= $prod['id']; ?>" class="btn btn-sm btn-warning">Modifier</a>
                                    <a href="../controller/delete_produit.php?id=<?= $prod['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce produit ?');">Supprimer</a>
                                </div>
                            </div>
                        </div>
                        <?php
